...
const Navbar = () => {
  ...
  return (
    ...
    <div>      
            ...
            <div className="flex items-center">
                <div className="flex items-center ml-3">
                  <div>
                    ...
                    >
                      <Image height={32} width={32} className="rounded-full" src="/1.jpg" alt="user photo" />
                    </button>
                  </div>
                </div>
              </div>
      ...
      {openDropDown &&
        <div className="z-50 right-4 top-48 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600">
